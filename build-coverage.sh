#in source directory
cmake -S . -B build -GNinja -DBUILD_SHARED_LIBS=OFF -DGIT_HELPER=OFF -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DCMAKE_CXX_COMPILER=/usr/bin/g++  -DCMAKE_C_COMPILER=/usr/bin/gcc -DCMAKE_MAKE_PROGRAM=/home/daria/Qt/Tools/Ninja/ninja -DQT_DIR=/home/daria/Qt/5.15.2/gcc_64/lib/cmake/Qt5 -DCMAKE_PREFIX_PATH=/home/daria/Qt/5.15.2/gcc_64 -DCMAKE_CXX_FLAGS="-fprofile-arcs -ftest-coverage"
cmake --build build
